...
function Login() {
    ...
    //disable the scorlling while in login page
    useEffect(()=>{
  ...
  return (
    ...
    backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        >
            ...
            rounded-full mt-5'>
                <img src={assets.circle_user} alt="" />
                <input type="text" placeholder='Username' required
                className='outline-none text-sm'onChange={e => setName(e.target.value)}
                value={name}/>
            </div>}
            ...
            rounded-full mt-4'>
                ...
                className='outline-none text-sm' onChange={e => setEmail(e.target.value)}
                value={email}/>
            </div>
            <div className='border px-6 py-2 flex items-center gap-2
            rounded-full mt-4'>
                ...
                className='outline-none text-sm' onChange={e => setPassword(e.target.value)}
                value={password}/>
            </div>
