...
function Header() {
  return (
    ...
    text-center my-20'>
        ...
        mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600'>image</span></h1>

        <p className='text-center max-w-xl mx-auto mt-5'>Your words, our canvas. 
            Transform your ideas into beautiful visuals with the power of AI.</p>
