...
function Header() {
  ...
  return (
    ...
    viewport={{once:true}}>
        ...
        >Turn text to <span className='text-blue-600'>image</span></motion.h1>
        ...
        >Your words, our canvas. 
            Transform your ideas into beautiful visuals with the power of AI.</motion.p>
        <motion.button className='sm:text-lg text-white bg-black
